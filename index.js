...
function filterStudentsByGrade(students, grade) {
  ...
  if (!Array.isArray(students)) {
    console.error("Помилка: аргумент 'students' має бути масивом");
  ...
  const filteredStudens = students.filter((students) => students.grade === grade);

  for (const student of filteredStudens) {
...
function compareArrays(arr1, arr2) {
  ...
  if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
    console.error("Перший аргумент має бути масивом, другий аргумент має бути масивом!");
    return null;
  }
